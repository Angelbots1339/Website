            ...
            <Grid container spacing={2}
                ...
                {data.tabs[index].GameName &&
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                        ...
                        >
                            <Typography variant={"h3"} sx={{marginLeft: bigScreen ? "20%" : "10%"}}>
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={8} xl={8} sx={{}}>
                        ...
                        >
                            <div style={{marginTop: '0%', justifyContent: "center"}}>
                                ...
                                <iframe
                                    src={'https://www.youtube.com/embed/' + data.tabs[index].GameReveal + "?enablejsapi=1&origin=http://angelbotics.org"}
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={8} xl={8}>
                        ...
                        >
                            <div style={{marginLeft: 10}}>
                                ...
                                <iframe
                                    src={'https://www.youtube.com/embed/' + data.tabs[index].RecapVideo + "?enablejsapi=1&origin=http://angelbotics.org"}
                                    // allow='autoplay; encrypted-media'
                                    allowFullScreen
                                    loading="lazy"
                                    style={{
                    ...
                    <Grid item xs={12} sm={12} md={12} lg={6} xl={6}>
                        ...
                        >
                            <div style={{marginLeft: 0}}>
                                ...
                                <iframe
                                    src={'https://www.youtube.com/embed/' + data.tabs[index].RevealVideo + "?enablejsapi=1&origin=http://angelbotics.org"}
                                    // allow='autoplay; encrypted-media'
                                    allowFullScreen
                                    loading="lazy"
                                    style={{
