                        ...
                        <Paper sx={{width: "100%", height: 2100}}>
                                    ...
                                    <div style={{
                                        ...
                                        <div style={{
                                            ...
                                            <Typography variant="h5" sx={{marginRight: 5}}>
                                                ...
                                                heavy, and fast-moving. Robots are made from many different materials, like
                                                Aluminum and Polycarbonate, and parts are often custom-machined, 3D printed,
                            ...
                            <div style={{
                                ...
                                <Card sx={{width: "50%", height: "100%"}}>
                                    ...
                                    <Typography variant="h5" sx={{marginRight: 5, marginBottom: 2}}>
